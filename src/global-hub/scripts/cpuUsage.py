...
def checkGlobalHubCpu(start_time, end_time, step):
    print(Back.GREEN + "")
    print(
        "============================================================================================="
    )
...
def global_hub_operator(pc, start_time, end_time, step):
    ...
    try:
        ...
        operator_cpu_trend_df.index = pandas.to_datetime(
            operator_cpu_trend_df.index, unit="s"
        )
