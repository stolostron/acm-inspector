...
def plotCPU(isCompactCluster):
    try:
        ...
        # Master Node capacity and Worker Nodes capacity
            ...
            plt.savefig('../../output/master-cpu-masternode.png')
            ...
            plt.savefig('../../output/master-cpu-workernode.png')            
    except Exception as e:
...
def plotMemory(isCompactCluster) :
    try :
        ...
        # Master Node capacity and Worker Nodes capacity
            ...
            plt.savefig('../../output/master-memory-masternode.png')
            ...
            plt.savefig('../../output/master-memory-workernode.png')
    except Exception as e:
